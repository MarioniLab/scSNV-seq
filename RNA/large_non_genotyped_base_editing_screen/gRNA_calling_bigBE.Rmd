...
folders_cellranger_iBAR <-  paste0("/nfs/research/marioni/magda/scJAK1_August_2022_cellranger/bigBE_iBAR",sapply(1:4,toString),"/outs")
file_name_gRNA_assignment <- "gRNA_assignment_bigBE.rds"
file_name_sce_list_after_QC <- "sce_list_bigBE.rds"
file_name_sce_list_after_gRNA_iBAR_assignment <- "sce_bigBE_gRNA_iBAR.rds"
...
saveRDS(merged_sce,file_name_sce_list_after_gRNA_iBAR_assignment)
```
